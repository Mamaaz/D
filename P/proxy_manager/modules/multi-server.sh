...
show_multi_server_menu() {
    while true; do
        ...
        echo -e "  ${CYAN}1.${RESET} 添加服务器"
        echo -e "  ${CYAN}2.${RESET} 删除服务器"
        echo -e "  ${CYAN}3.${RESET} 查看服务器列表"
        echo ""
        echo -e "${YELLOW}状态监控${RESET}"
        echo -e "  ${CYAN}4.${RESET} 批量查看状态"
        echo -e "  ${CYAN}5.${RESET} 查看单个服务器详情"
        echo ""
        echo -e "${YELLOW}批量操作${RESET}"
        echo -e "  ${CYAN}6.${RESET} 批量重启服务"
        echo -e "  ${CYAN}7.${RESET} 批量卸载服务"
        echo ""
